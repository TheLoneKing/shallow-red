...
/**
 * ShallowRedBot listens for challenges and spawns Games on accepting.
 *  
 */
class ShallowRedBot {

  /**
   * Initialise with access token to lichess and a player engine.
   */
